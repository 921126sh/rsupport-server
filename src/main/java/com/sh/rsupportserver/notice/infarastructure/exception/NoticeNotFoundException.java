...
public class NoticeNotFoundException extends DataNotFoundException {
     ...
     * @param code 오류코드
     */
    public NoticeNotFoundException(String code) {
     ...
     * @param cause 원인예외
     */
    public NoticeNotFoundException(String code, Throwable cause) {
     ...
     * @param cause           원인예외
     */
    public NoticeNotFoundException(String code, Object[] codeMessageArgs, Throwable cause) {
